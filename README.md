...
Silas Sun, Alper Eroglu, Jean Hausser at [Karolinska Institutet & SciLifeLab](https://www.hausserlab.org), Stockholm Sweden
...
1. **Install bioLUCID**
   ...
   ```bash
   pip install -i https://test.pypi.org/simple/ biolucid
   ```
...
4. **Visualize the results**
   ...
   With no sample over the "80% batch effect" line, these results suggest that batch effects are all low enough in all the samples of this dataset to include them all for  downstream analyses (marker analysis, trajectory analysis, machine-learning, etc.), even though sample D6 should be included with some caution.
